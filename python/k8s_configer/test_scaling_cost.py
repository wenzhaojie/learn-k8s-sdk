...
def exp_different_replicas_resource_node(name, namespace, init_replicas_list, target_replicas_list, resource_list, node_name_list_list, is_wait_until_no_unavailable=False, filename="scaling-cost.csv", save_root="./results"):
